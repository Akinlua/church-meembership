...
// Middleware
app.use(cors({
  origin: ['https://newlightxyz.com', 'https://www.newlightxyz.com', 'http://localhost:3000', 'http://localhost:3001'],
...
const groupMembersRouter = require('./routes/groupMembers')(app);
